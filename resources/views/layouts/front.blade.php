            ...
            <div class="auto-container clearfix">
                <div class="top-left clearfix">
                    <ul class="list">
						...
						<li><span class="icon fas fa-phone"></span> <a href="{{asset('assets/tel:+555–123–2323') }}"> 555–123–2323</a></li>
					</ul>
                </div>
        ...
        <div class="sticky-header">
        	<div class="auto-container clearfix">
            	...
            	<div class="logo pull-left">
                	<a href="index.html" class="img-responsive"><img src="{{asset('assets/images/logo-small.png') }}" alt="" title=""></a>
                </div>
